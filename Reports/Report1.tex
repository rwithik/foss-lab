...
\includegraphics[scale=2]{../Images/Report1/man1.png}\\
\\
\includegraphics[scale=2]{../Images/Report1/man2.png}\\
\\
Command 2: ls\\
...
Usage: ls [PATH]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/ls.png}\\
\pagebreak
\\
Command 3: cd\\
...
Usage: cd [PATH]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/cd.png}\\
\\
Command 4: pwd\\
Purpose of Command: Prints the present working directory.\\
Usage: pwd\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/pwd.png}\\
\\
Command 5: echo\\
Purpose of Command: Print to the terminal.\\
Usage: echo [ARGS]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/echo.png}\\
\\
Command 6: mkdir\\
...
Usage: cd [NAME]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/mkdir.png}\\
\pagebreak
\\
Command 7: touch\\
...
Usage: rm [PATH]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/rm.png}\\
\\
Command 11: tree\\
Purpose of Command: Displays the contents of a folder in tree structure.\\
Usage: tree [PATH]\\
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/tree.png}\\
\pagebreak
\\
Command 12: cat\\
...
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/cat.png}\\
\\
Command 13: head\\
...
Usage: head [FILE]\\
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/head.png}\\
\pagebreak
\\
Command 14: tail\\
...
Usage: tail [FILE]\\
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/tail.png}\\
\\
Command 15: less\\
Purpose of Command: Prints the contents of a file, one screen at a time.\\
Usage: less [FILE]\\
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/less.png}\\
\pagebreak
\\
Command 16: chmod\\
...
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/chmod.png}\\
\\
...
{[COMMAND1]} $>>$ [COMMAND2]\\
Sample Input and Output:\\
\includegraphics[scale=2]{../Images/Report1/redirection.png}\\
\\
Operation 2: Piping\\
Purpose: Give the output of one command to another command.\\
Usage: [COMMAND1] $|$ [COMMAND2]\\
Sample Input and Output:\\
\includegraphics[scale=.5]{../Images/Report1/piping.png}\\
\pagebreak
\\
Operation 3: sort\\
...
Usage: [COMMAND] $|$ sort\\
Sample Input and Output:\\
\includegraphics[scale=.5]{../Images/Report1/sort.png}\\
\\
Operation 4: uniq\\
Purpose: Excludes adjacent identical lines from the input.\\
Usage: [COMMAND1] $|$ uniq\\
Sample Input and Output:\\
\includegraphics[scale=.5]{../Images/Report1/uniq.png}\\
\pagebreak
\\
...
Usage: jobs\\
Sample Input and Output:\\
\includegraphics[scale=2]{../Images/Report1/jobdisplay.png}\\
\\
...
killall [NAME]\\
Sample Input and Output:\\
\includegraphics[scale=2]{../Images/Report1/kill.png}\\
\\
Operation 7: ps\\
Purpose: Display the active processes in the current shell session.\\
Usage: ps\\
Sample Input and Output:\\
\includegraphics[scale=2]{../Images/Report1/ps.png}\\
\\
...
Usage: curl [URLs]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/curl.png}\\
\\
Command 2: wget\\
Purpose: \\
Usage: wget [URLs]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/wget.png}\\
\\
Command 3: ftp\\
Purpose: Remote file transfer with File Transfer Protocol.\\
Usage: ftp [IP or DOMAIN]\\
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/ftp.png}\\
\pagebreak
\\
Command 4: ssh\\
...
Sample Input and Output: \\
\includegraphics[scale=2]{../Images/Report1/ssh.png}\\
\\
Command 5: grep\\
...
Sample Input and Output: \\
\includegraphics[scale=.5]{../Images/Report1/grep.png}
